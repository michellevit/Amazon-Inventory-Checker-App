# Amazon-Checker-GUI/scripts/step_2_scripts.py
# GitHub Repository: https://github.com/michellevit/Amazon-Inventory-Checker-App
#
# This script is part of my Amazon Inventory Checker App project.
# I’m especially proud of this application because it was the first project I ever built. 
# Over the years, as I’ve learned and grown, I’ve refactored it countless times - improving it piece by piece, and so it has become a sort of reflection of my entire learning journey.
#
# I chose this snippet because it tackles a really interesting real-world optimization problem.
# Before I had even learned what data structure and algorithms were, this project forced me to consider how many different ways this optimization problem could be tackled, and how minor changes in the order would create major differences in the efficiency and end result.
#
# For a demo which explains the algorithm challenges with a clear example, see my demo video at timestamp 3:22: https://www.youtube.com/watch?v=lD-wTry930w&t=25s
#
# While I'm very proud of it, now that I've learned more about object oriented structures, I’d like to refactor it into a cleaner, class-based design as my next step.
